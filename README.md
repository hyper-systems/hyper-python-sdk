...
Install/Update to latest stable release using pip:

```shell
pip install -U git+https://github.com/hyper-systems/hyper-python-sdk
```

## Adding as a dependency of your project

If your project is using pip, add this library as a dependency in your `requirements.txt`, preferably lock it to a specific release:

```shell
echo "git+https://github.com/hyper-systems/hyper-python-sdk@1.0.0" >> requirements.txt
```

If your project is using poetry:
